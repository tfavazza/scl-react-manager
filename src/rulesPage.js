...
<div>
      ...
      <p>Following bans, the player who banned first picks a non-banned vanue layout first, followed by the other. This first pick of each player will be played TWICE (twice each as spy and sniper for each player). Then each player picks a further venue which will be played ONCE. </p>
